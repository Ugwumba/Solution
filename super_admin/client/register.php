            ...
            <div class="col-xl-4 col-lg-5 col-md-7 d-flex flex-column ms-auto me-auto ms-lg-auto me-lg-5">
              <div class="card card-plain">
                <div class="card-header bg-transparent">
                  ...
                  <p class="mb-0">Enter your correct details</p>
                </div>
                ...
                <div class="card-body">
                  ...
                  <a style="align-items: right;" href="login.php">
                    <button type="link" class="btn btn-lg bg-outline-primary btn-lg  mt-4 mb-0">Already have an account?</button>
                  </a>
                </div>
              </div>
            </div>
